  ...
  if (loading) {
    return (
      <div className="border p-4 rounded-lg shadow-md max-w-md min-h-[200px]">
        ...
        <div className="h-4 bg-gray-300 rounded w-2/3 mb-4"></div> {/* Placeholder for description */}
        <div className="flex justify-between mt-4">
          <div className="h-4 bg-gray-300 rounded w-1/4"></div> {/* Placeholder for stars */}
          <div className="h-4 bg-gray-300 rounded w-1/4"></div> {/* Placeholder for forks */}
          <div className="h-4 bg-gray-300 rounded w-1/4"></div> {/* Placeholder for language */}
        </div>
      </div>
    );
  }
